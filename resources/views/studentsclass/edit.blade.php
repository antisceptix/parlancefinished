...
@section('content')
<form class="" action="{{ route('studentsclass.update',['1' => $user_info->id, 'classesclass' => $user_info3->id] ) }}" method="POST" name="edit_class">
{{ csrf_field() }}
@method('PATCH')
    <div class="col-sm-10">
<div>
...
<div class="col-sm-12">
<div class="card">
  <h5 class="card-header">Edit class for {{ $user_info->student_name }} - {{ $user_info3->classes_name }} </h5>
  <div class="card-body">
    <div class="col-md-12">
